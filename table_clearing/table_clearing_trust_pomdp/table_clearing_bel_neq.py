...
class TableFileGenerator:
    ...
    def InitTrustDyna(self):
        hBehav = {'Fish Can': array([[ 0.56084399,  0.43915601],
            [ 0.38185519,  0.61814481],
            [ 0.26241808,  0.73758192],
            [ 0.1960706 ,  0.8039294 ],
            [ 0.16092793,  0.83907207],
            [ 0.14218366,  0.85781634],
            [ 0.13200083,  0.86799917]]),
     'Glass Cup': array([[ 0.91035856,  0.08964144],
            [ 0.82114354,  0.17885646],
            [ 0.68603592,  0.31396408],
            [ 0.52755736,  0.47244264],
            [ 0.38263846,  0.61736154],
            [ 0.27270316,  0.72729684],
            [ 0.19777272,  0.80222728]]),
     'Water Bottle': array([[ 0.29739666,  0.70260334],
            [ 0.28527439,  0.71472561],
            [ 0.27810022,  0.72189978],
            [ 0.2740091 ,  0.7259909 ],
            [ 0.27172455,  0.72827545],
            [ 0.2704636 ,  0.7295364 ],
            [ 0.26977206,  0.73022794]])}
...
xmlTable.XmlGen("pomdpx/tableClearingBelNeq.pomdpx")
